...
def generate_track_walls(track_spine, widths_dict, is_track_complete = False):
    ...
    for i in range(1, len(width_indices)):
        ...
        for t in range(start_track_index, end_track_index):
            ...
            def _check_wall_point_validity(wall_point):
            ...
            is_outer_wall_valid= _check_wall_point_validity(outer_wall_point)
            is_inner_wall_valid = _check_wall_point_validity(inner_wall_point)
